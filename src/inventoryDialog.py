...
class InventoryDialog(dialog.Dialog):
    ...
    def draw(self, win):        
        ...
        win.blit(self.BodyFont.render(self.PC.rightHandEquipped.Description() if self.PC.rightHandEquipped != None else (('(' + self.PC.leftHandEquipped.Description() + ')') if self.PC.leftHandEquipped != None and self.PC.leftHandEquipped.TwoHanded  else 'Empty'), True, (255, 255, 255, 255)), (122, 55))        
        win.blit(self.BodyFont.render(self.PC.leftHandEquipped.Description() if self.PC.leftHandEquipped != None else (('(' + self.PC.rightHandEquipped.Description() + ')') if self.PC.rightHandEquipped != None and self.PC.rightHandEquipped.TwoHanded  else 'Empty'), True, (255, 255, 255, 255)), (122, 75))
        ...
        for i in enumerate(self.PC.backpack):           
            win.blit(self.BodyFont.render(i[1].Description(), True, (255, 255, 255, 255)), (30, 125 + i[0] * 20))
            
        for i in enumerate(self.FloorItems):            
            win.blit(self.BodyFont.render(i[1].Description(), True, (255, 255, 255, 255)), (30, 275 + i[0] * 20))
